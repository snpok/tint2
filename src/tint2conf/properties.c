...
GdkPixbuf *load_icon(const gchar *name)
{
    ...
    int size = 22;
    char *path = get_icon_path(icon_theme, name, size, FALSE, TRUE);
...
void create_taskbar(GtkWidget *parent)
{
    ...
    col++;
    gtk_tooltips_set_tip(tooltips,
                         taskbar_name_active_background,
    ...
    col++;
    gtk_tooltips_set_tip(tooltips,
                         taskbar_name_inactive_background,
...
void create_tooltip(GtkWidget *parent)
{
    ...
    gtk_tooltips_set_tip(tooltips,
                         tooltip_font_color,
                         _("Specifies the font color used to display the text of the tooltip."),
                         NULL);
